...
//        http.addFilterBefore(corsFilter(), SessionManagementFilter.class);
        ...
        http.authorizeHttpRequests().antMatchers(UriMapper.LOGIN + "/**", UriMapper.REFRESH_TOKEN + "/**", UriMapper.USER_BASE +  UriMapper.CREATE_USER + "/**", UriMapper.DEVICE_BASE + UriMapper.GET_RANDOM_ID).permitAll();
